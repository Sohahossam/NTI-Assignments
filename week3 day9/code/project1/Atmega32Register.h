...
/*------------------------------------------*/
#define OCRO_Reg *((volatile uint8_t *)0x5C)
...
#define TCCRO_Reg *((volatile uint8_t *)0x53)
#define TCNTO_Reg *((volatile uint8_t *)0x52)
#define OSCCAL_Reg *((volatile uint8_t *)0x52)
...
#define UBRRH_Reg *((volatile uint8_t *)0x41)
